...
<div style="margin: 16px">
    <form action="../openUserServlet" method="post" class="layui-form">
        <table class="layui-table" id="test" lay-filter="test">
            ...
            <c:if test="${user!=null}">
                ...
                <tr>
                    <td colspan="2"><button type="submit" class="layui-btn layui-btn-fluid" ><i class="layui-icon layui-icon-auz"></i>  启  封 </button></td>
                </tr>
            </c:if>
        </table>
    </form>
