        ...
        <table class="layui-table" id="test" lay-filter="test">
            <%
                ...
                if(request.getAttribute("company")!=null) {
                    ...
                    //获取距离最后汇缴月的月份差
                    String lastpaydate = company.getLASTPAYDATE();
                    String[] split = lastpaydate.split("-");
            ...
            <c:if test="${company!=null}">
                ...
                <script>
                    ...
                    if(monthdiff>1) layer.alert("该单位已经有"+monthdiff+"个月未汇缴，请先补缴");
                </script>
                <tr>
                    <td>单位账号</td>
                ...
                <tr>
                    <td colspan="2"><button type="submit" class="layui-btn layui-btn-fluid" ><i class="layui-icon layui-icon-auz"></i>  补 缴 </button></td>
                </tr>
            </c:if>
        </table>
    </form>
