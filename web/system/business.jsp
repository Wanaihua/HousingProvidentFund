...
<script>
    ...
    layui.use(['table', 'dropdown'], function(){
        ...
        table.render({
            elem: '#test'
            ,url:'../businessShowServlet' // 此处为静态模拟数据，实际使用时需换成真实接口
            ,toolbar: '#toolbarDemo'
            ...
            ,cols: [[
                ...
                ,{field:'id', fixed: 'left', width:200, title: '键值信息', sort: true, totalRowText: '合计：'}
                ,{field:'businessMessage', minwidth:260, title: '描述'}
                ,{field:'time', width:120, title: '时间'}
                ,{field:'user', width:120, title: '操作人'}
            ]]
            ,done: function(){
                var id = this.id;
                // 下拉按钮测试
